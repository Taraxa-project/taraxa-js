...
exports.getScheduleBlockByPeriod = (period) => {
    period = tag_check(period)
    return taraxa_rpc("taraxa_getScheduleBlockByPeriod", [period])
}
exports.protocolVersion = () => {
    return taraxa_rpc_int("taraxa_protocolVersion")
}